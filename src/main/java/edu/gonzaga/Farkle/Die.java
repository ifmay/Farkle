...
public class Die implements Comparable<Die> {
    ...
    /**
     * Constructs a die object with default number of sides and default side up.
     */
    public Die() {
    ...
    /**
     * Constructs a die object with specified number of sides and default side up.
     *
    ...
    /**
     * Constructs a die object with specified number of sides and specified starting side up.
     *
     * @param numSides      Number of sides for the die
     * @param startingSide  Initial side facing up
     */
    ...
    /**
     * Provides the ability to convert the Die object into a string representation
